...
@section('content')
  ...
  <!--Float Button-->
  <div class="container float" style="width: 70px; width: absolute;  margin-right: 20px; box-shadow: inset;  z-index: 999;">
...
<div class="container py-1">
    ...
    <div style="padding-top:120px">
        <h3 class="font-weight-bold mb-0" style="color: black;">Dealer</h3>
        <p class="font-italic text-muted mb-4">Pilih Berdasarkan Plat Nomor daerah anda</p>
        <div class="row">
            <!-- DEMO 3 Item-->
            @foreach ($regions as $wilayah)
            <div class="col-lg-6 mb-3 mb-lg-5">
                <a href="{{ url('dealer/list-dealer/'.$wilayah->id) }}">
                <div class="hover hover-3 text-white rounded"><img  style="width:100%; height:100%;" src="{{ asset($wilayah->gambar) }}">
                        <div class="hover-overlay"></div>
                        <div class="hover-3-content px-5 py-4">
                            {{-- <h3 class="hover-3-title text-uppercase font-weight-bold mb-1"><span
                                    class="font-weight-light">{{ $wilayah->provinsi }}</span></h3> --}}
                            <p class="hover-3-description small text-uppercase mb-0">Plat Nomor<br>{{ $wilayah->nomor_polisi }}</p>
                        </div>
                    </div>
                </a>
                </div>
