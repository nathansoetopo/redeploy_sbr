...
<div class="tab-nav-container" style="height: 80px; background-color:#3E8ED6;">
  ...
  <!-- Banner Starts Here -->
    ...
    <div class="services" style="margin-top: -10%;">
      <div class="container">
        <div class="row">
                ...
                <div class="contact-form">
                   <form action="#">
                     ...
                     <select class="form-control select2" id="lokasi" >
                      ...
                      <option value="{{ $dealer->lokasi }}">{{ $dealer->lokasi }}</option>                             
                      @endforeach
                    </select>
             ...
             @foreach ($dealers as $dealer)
              <div class="col-md-4">
                <div class="product-item">
                  <a href="{{ url('/dealer/list-dealer/detail/'.$dealer->id) }}"><img src="{{ asset($dealer->gambar) }}" alt=""></a>
                  <div class="down-content">
                    <a href="{{ url('/dealer/list-dealer/detail/'.$dealer->id) }}"><h4>{{ $dealer->nama_dealer }}</h4></a>
                    <h6>{{ $dealer->lokasi }}</h6>
                  </div>
                </div>
              </div>
        ...
        <h3 class="font-weight-bold mb-0" style="color: black;">List Dealer</h3>
              ...
              <!--         <div class="col-sm-1"></div> -->
                    <div class="">
                         <div class="card-container manual-flip">
                            ...
                            <div class="card" style="margin-top: -80%;">

                                <div class="front">
                                    <div style="height: 280px" class="cover">
                                      <img style="height: 245px" src="{{ asset($dealer->gambar) }}" alt="">
                                    </div>
                                    <div class="content">
                                        <div style="margin-top:-30px" class="main">
                                          <h3 class="name">{{ $dealer->nama_dealer }}</h3>
                                          <p class="text-center">{{ $dealer->lokasi }}</p>
                                        </div>
                                        <div style="margin-top:-60px" class="footer">
                                            <button class="btn btn-simple" onclick="rotateCard(this)">
                                                <i class="fa fa-mail-forward"></i> Check more information
                                            </button>
                                        </div>
                                    </div>
                                </div> <!-- end front panel -->
                                <div class="back">
                                    <div class="header">
                                        <h5 class="motto">Sumber Baru Rejeki Sukoharo</h5>
                                    </div>
                                    <div class="content">
                                        <div class="main">
                                          <div id="map" style="transform: translate(0px, -30px);">
                                            <iframe style="display: none;"></iframe>
                                            <div class="mapouter"><div class="gmap_canvas"><iframe width="100%" height="330px" id="gmap_canvas" src="{{ $dealer->link_lokasi }}" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://2piratebay.org"></a><br><style>.mapouter{position:relative;text-align:right;height:500px;width:600px;}</style><a href="https://www.embedgooglemap.net"></a><style>.gmap_canvas {overflow:hidden;background:none!important;height:230px;width:280px;}</style></div></div>
                                    ...
                                    <div class="footer">
                                        <button style="padding-left: 40%" class="btn btn-simple" rel="tooltip" title="Flip Card" onclick="rotateCard(this)">
