...
@section('content')
  ...
  <!--</div>-->
    <div class="services" style="padding-bottom: 0; padding-top:150px;">
      <div class="container">
        <div class="row" style="padding-left: 4%; padding-right:4%;">
          <div class="col-md-12">
            <div class="row">

        <h3 class="font-weight-bold mb-4" style="color: black;">List Dealer</h3>
            ...
            <div class="col-lg-4 col-md-4 col-12">
              <center>
                <div class="service-item">
                  ...
                  <ins class="adsbygoogle" style="height: 0;"
                    style="display:block"
                        ...
                        <div class="">
                            <div class="card-container manual-flip">
                                <div class="card">
                                    ...
                                    <div class="back">
                                        <div class="header">
                                            <h5 class="motto">Sumber Baru Rejeki</h5>
                                        </div>
                                        <div class="content">
                                          <div class="container-fluid" style="padding: 0;"><iframe width="100%" height="200px" id="gmap_canvas" src="{{ $dealer->link_lokasi }}" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://2piratebay.org"></a><br><style>.mapouter{position:relative;text-align:right;height:500px;width:600px;}</style><a href="https://www.embedgooglemap.net"></a><style>.gmap_canvas {overflow:hidden;background:none!important;width:100%; height:auto}</style></div>
                                        </div>
                                        <div class="footer">
