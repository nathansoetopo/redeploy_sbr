...
<div class="container py-1" id="motor">
    <div style="padding-top:120px">
        <h3 class="font-weight-bold mb-0" style="color: black;">Produk</h3>
        <p class="font-italic text-muted mb-4">Pilih Berdasarkan Plat Nomor daerah anda</p>
        <div class="row">

            @php
                $motors = DB::table('motors')->get();
            @endphp
            @foreach ($regions as $wilayah)
            <div class="col-lg-6 mb-3 mb-lg-5">
                    <a href="{{ url('produk/list-motor/'. $wilayah->id) }}">
