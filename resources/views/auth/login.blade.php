        ...
        <section class="section">
            ...
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        <img src="{{ asset('assets/images/LOGO SBR.png') }}" alt="logo" width="80"
                            class="shadow-light rounded-circle mb-5 mt-2">
                        <h4 class="text-dark font-weight-normal">Welcome to <span class="font-weight-bold">Dealer SBR</span>
                        </h4>
                      </br>
                        ...
                        <div class="text-center mt-5 text-small">
                            Copyright &copy; SBR. Made with 💙 by LanternTech
                            <div class="mt-2">
                ...
                <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom"
                    data-background="{{ asset('assets/images/sbrsolo.jpg') }}">
