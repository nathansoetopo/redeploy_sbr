                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        @endif
                                        <form action="{{ route('store.motor') }}" method="POST"
                                                ...
                                                <div class="col-sm-12 col-md-7">
                                                    <select class="form-control select2" name="plat">
                                                        @foreach ($regions as $region)
                                                            <option value="{{ $region->nomor_polisi }}">
                                                                {{ $region->nomor_polisi }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row mb-4">
                                                <label
                                                    class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Berat
                                                    Motor</label>
                                                <div class="col-sm-12 col-md-7">
                                            ...
                                            <div class="form-group row mb-4">
                                                <label
                                                    class="col-form-label text-md-right col-12 col-md-3 col-lg-3">PxLxT
                                                    (Volume)</label>
                                                <div class="col-sm-12 col-md-7">
